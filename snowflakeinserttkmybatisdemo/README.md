...
```
cd existing_repo
git remote add origin https://gitlab.com/llleeeeeeee/snowflakeinserttkmybatisdemo.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/llleeeeeeee/snowflakeinserttkmybatisdemo/-/settings/integrations)
