...
public class SnowFlakeUtilz {
    ...
    private static SnowFlakeUtilz snowFlakeUtil;

    static {
        snowFlakeUtil = new SnowFlakeUtilz();
    }
     ...
     * @param workerId
     */
    public SnowFlakeUtilz(long dataCenterId, long workerId) {
        // 检查dataCenterId的合法值
    ...
    public static void main(String[] args) {
        SnowFlakeUtilz snowFlakeUtil = new SnowFlakeUtilz();
        for(int i=0;i<10;i++){
